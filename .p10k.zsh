# Generated by Powerlevel10k configuration wizard on 2025-07-02 at 17:21 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%6F'  # yellow foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=242
